...
/*
 * JFCadCaracteristicas.java
 *
 * Created on 01/06/2010, 18:41:00
 */
 ...
 * @author cledsonfs
 */
public class JFCadCaracteristicas extends javax.swing.JFrame {

    private Usuario usuario;
    private boolean alterar = false;
    private CaracteristicaController controller = new CaracteristicaController();
    private Caracteristica alterarCaracteristica = null;
    private String menssagem = "";
    private HashMap<String, String> parametros;

    /** Creates new form JFCadCaracteristicas */
    public JFCadCaracteristicas(Usuario usuario) {
    ...
    private void initComponents() {
        ...
        setTitle(".:JSIAFF:Cadastro de Características:.");

        jLabel1.setFont(new java.awt.Font("Arial", 1, 14));
        jLabel1.setForeground(new java.awt.Color(0, 0, 128));
        jLabel1.setText("Cadastro de Características");
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        if (jTable1.getSelectedRow() > -1) {
            ...
            alterarCaracteristica = controller.localizarPorID(id);
            jTFDescricao.setText(alterarCaracteristica.getDescricao().trim());
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (jTable1.getSelectedRow() > -1) {
            int id = (Integer) jTable1.getValueAt(jTable1.getSelectedRow(), 0);
            Caracteristica caracteristica = controller.localizarPorID(id);
            if (caracteristica != null && caracteristica.getIdcaracteristica() > -1) {
                ...
                if (opc == 0) {
                    ...
                    try {
                        ...
                        Logger.getLogger(JFCadCaracteristicas.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
            }
        }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (alterar && alterarCaracteristica != null) {
            caracteristica = alterarCaracteristica;
        } else {
            caracteristica = new Caracteristica();
            caracteristica.setDatacadastro(new Timestamp(new Date().getTime()));
        }

        caracteristica.setDescricao(jTFDescricao.getText().trim().toUpperCase());
        caracteristica.setIdUsuario(usuario.getIdUsuario());
    ...
    private void limpaTela() {
        jTFDescricao.setText("");
        alterar = false;
        alterarCaracteristica = null;
        jTFDescricao.setEnabled(false);
        menssagem = "";
    }

    private void cargatabela() {
        jTable1.setModel(new CaracteristicaTabela());
    ...
    private void jBImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBImprimirActionPerformed
        try {
            List<Caracteristica> caracteristicas = controller.getTodos();
