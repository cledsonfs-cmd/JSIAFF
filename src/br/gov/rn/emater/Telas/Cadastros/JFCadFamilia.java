...
import br.gov.rn.emater.Modelos.FamiliaTabela;
 ...
 * @author cledsonfs
 */
public class JFCadFamilia extends javax.swing.JFrame {

    private Usuario usuario;
    private boolean alterar = false;
    private FamiliaController controller = new FamiliaController();
    private Familia alterarFamilia = null;
    private String menssagem = "";
    private HashMap<String, String> parametros;

    /** Creates new form JFCadFamilia */
    public JFCadFamilia(Usuario usuario) {
    ...
    private void initComponents() {
        ...
        setTitle(".:JSIAFF:Cadastro de Famílias:.");

        jLabel1.setFont(new java.awt.Font("Arial", 1, 14));
        jLabel1.setForeground(new java.awt.Color(0, 0, 128));
        jLabel1.setText("Cadastro de Famílias");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (jTable1.getSelectedRow() > -1) {
            ...
            Familia familia = controller.localizarPorID(id);
            if (familia != null && familia.getIdfamilia() > -1) {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (alterar && alterarFamilia != null) {
            familia = alterarFamilia;
        } else {
            familia = new Familia();
        }
        familia.setDescricao(jTFDescricao.getText().trim().toUpperCase());
        familia.setDatacadastro(new Timestamp(new Date().getTime()));
        familia.setIdUsuario(usuario.getIdUsuario());
        controller.set(familia);
        try {
            boolean retorno = controller.excluir();
            menssagem = controller.getMenssagemRetorno();
    ...
    private void jBImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBImprimirActionPerformed
        try {
            List<Familia> familias = controller.getTodos();
    ...
    private void cargatabela() {
        jTable1.setModel(new FamiliaTabela());
