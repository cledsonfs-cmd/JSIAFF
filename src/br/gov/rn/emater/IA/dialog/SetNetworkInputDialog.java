	...
	public void Ok() {
		try {
			...
			JOptionPane.showConfirmDialog(
							null,
							"Formato inválido de entrada! Todas as entradas devem ser valores númericos.\nPor favor forneça os valores da rede com numeros separados por espaço.",
							".:JSIAFF:Error:.", JOptionPane.DEFAULT_OPTION);
		} catch (Exception e) {
			JOptionPane.showConfirmDialog(null, e.getMessage(), ".:JSIAFF:Error:.",
