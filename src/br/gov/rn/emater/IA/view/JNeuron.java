...
//				g2d.draw(circle);                                     // Now draw it
	...
	@SuppressWarnings("unchecked")
        ...
        private void initComponents() {
                ...
                org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(br.gov.rn.emater.IA.NeuronsApplication.class).getContext().getResourceMap(JNeuron.class);
...
private void propertiesButtonMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_propertiesButtonMousePressed
        NeuronsApplicationView.getInstance().openNeuronPropertiesFrame(neuron);
